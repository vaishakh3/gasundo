    ...
    <aside className="hidden w-[380px] shrink-0 border-r border-white/8 bg-[linear-gradient(180deg,rgba(8,14,30,0.98),rgba(7,11,24,0.96))] lg:flex lg:h-full lg:min-h-0 lg:flex-col">
      <div className="flex h-full min-h-0 flex-col px-4 py-4">
        ...
        <div className="relative mt-4 min-h-0 flex-1">
          <div className="pointer-events-none absolute inset-x-0 top-0 z-10 h-6 bg-gradient-to-b from-[rgba(8,14,30,0.96)] to-transparent" />
          <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-8 bg-gradient-to-t from-[rgba(8,14,30,0.98)] to-transparent" />

          <div className="desktop-sidebar-scroll h-full overflow-y-auto pr-1">
            <div className="space-y-4 pb-6">
              ...
              <section className="overflow-hidden rounded-[24px] border border-white/8 bg-[rgba(12,18,36,0.78)] shadow-[0_20px_50px_rgba(5,8,22,0.22)]">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <span className={`inline-flex items-center gap-2 rounded-full border px-3 py-1 text-[0.62rem] font-semibold uppercase tracking-[0.22em] ${record.meta.badgeClass}`}>
