...
export default function ZoomControl({
  ...
  return (
    <div
      className="pointer-events-auto absolute right-4 bottom-[calc(var(--app-floating-bottom-offset)+env(safe-area-inset-bottom)+96px)] z-[1002] flex flex-col gap-2.5 lg:right-7 lg:bottom-[124px]"
      role="group"
