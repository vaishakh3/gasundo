...
export const metadata = {
  ...
  title: {
    default: 'GasUndo | Kerala Restaurant Status Map',
    template: '%s | GasUndo',
  },
  description:
    'GasUndo is a live Kerala restaurant status map for LPG shortage updates. Check open, limited-menu, and closed restaurants district by district across Kerala.',
  keywords: [
    'gas undo',
    'gasundo',
    'gas undo kerala',
    'gasundo kerala',
    'restaurants open in Kerala',
    'Kerala restaurant status',
    'Kerala LPG shortage restaurants',
    'restaurants open now Kerala',
    'live map restaurants Kerala',
    'district wise restaurant map Kerala',
    'restaurants running limited menu Kerala',
    'restaurants affected by LPG shortage Kerala',
    'which restaurants are open in Kerala today',
    'Ernakulam restaurant status',
    'Kozhikode restaurant status',
    'map showing restaurants open in Kerala',
  ],
  alternates: {
    canonical: '/',
  },
  openGraph: {
    title: 'GasUndo | Kerala Restaurant Status Map',
    description:
      'Track open, limited-menu, and closed restaurants across Kerala with district-wise loading for a faster map and search experience.',
    url: '/',
    siteName: 'GasUndo',
    locale: 'en_IN',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'GasUndo Kerala restaurant status map',
      },
    ],
  },
  twitter: {
    ...
    title: 'GasUndo | Kerala Restaurant Status Map',
    description:
      'Live Kerala restaurant status map for open, limited-menu, and closed places during the LPG shortage.',
  ...
  other: {
    ...
    'geo.position': '10.1632;76.6413',
    ICBM: '10.1632, 76.6413',
  },
  manifest: '/manifest.json',
  appleWebApp: {
    capable: true,
    statusBarStyle: 'black-translucent',
    title: 'GasUndo Kerala',
    startupImage: [
